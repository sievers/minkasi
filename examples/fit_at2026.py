...
outroot = "/mnt/welch/USERS/jorlo/Reductions/AT2026dbl_{}".format(obs_id) #CHANGE ME!
...
idir = "/mnt/welch/MUSTANG/M2-TODs/AT2026dbl_{}/".format(obs_id) #CHANGE ME
